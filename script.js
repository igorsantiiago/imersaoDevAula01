function calcMedia() {
    ...
    var verificarAprovacao = calculate;

    if (verificarAprovacao >= 7) {

        verificarAprovacao = "Aprovado";
    } else {

        verificarAprovacao = "Reprovado";
    }

    console.log(verificarAprovacao);

    document.querySelector("#result").innerHTML = ("Sua nota final é <br>") + calculate + "-" + verificarAprovacao;
}
